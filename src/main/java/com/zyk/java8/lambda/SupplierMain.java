...
public class SupplierMain {
    ...
    public static void main(String[] args) {
        ...
        Assert.assertThat(upperCase.andThen(duplicate).apply("test"), is("TESTTEST"));
        ...
        Assert.assertThat(subtraction.apply(add.apply(1, 2), 3), is(0));
    }
